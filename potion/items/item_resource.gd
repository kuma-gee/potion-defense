...
const PROCESSES = {
	...
	Process.DISTILL: {
		Type.FROST_LEAF_CUTTED: Type.FROST_LEAF_DISTILL,
	},
	Process.CUT: {
		Type.RED_HERB: Type.RED_HERB_CUTTED,
		Type.FROST_LEAF: Type.FROST_LEAF_CUTTED,
	},
}
...
const RECIPIES = {
	...
	Type.POTION_HOLY: [Type.FROST_LEAF_DISTILL, Type.CRYSTAL],
